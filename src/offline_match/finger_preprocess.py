...
class data_Process():
    def __init__(self, online_file, offline_file, offline_audio_thd=600 * 1024) -> None:
    ...
    def conflict_prob_analysis(self, win_size, bins_count):
        url_dict = {}
        index_i = -1
        video_chunk_size_max = 2 * 1024 * 1024.0
...
if __name__ == '__main__':
    ...
    finger_data = data_Process('../../data/fingerprint/online.csv',
                               '../../data/fingerprint/finger.csv', offline_audio_thd)
