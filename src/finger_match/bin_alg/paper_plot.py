...
def hist_plt():
    file = open("/Users/hale/PycharmProjects/batch_video_clawer/data/paper_plt/size_res.csv", mode='r',
                encoding='utf-8')
...
def zhe_plt():
    file = open("/Users/hale/PycharmProjects/batch_video_clawer/data/paper_plt/chunk_error.csv", mode='r',
                encoding='utf-8')
    file_datas = file.read()
    datas = file_datas.split('\n')
    finger = []
...
def multi_zhe_plt():
    file = open("/Users/hale/PycharmProjects/batch_video_clawer/data/paper_plt/bins_orders.csv", mode='r',
                encoding='utf-8')
    file_datas = file.read()
    datas = file_datas.split('\n')
    X = []
